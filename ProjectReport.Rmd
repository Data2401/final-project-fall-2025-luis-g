...
meteroite <- meteroite %>% 
  ...
  mutate(
    reclat = case_when(
      ...
      reclat_original == 0 & reclong_original == 0 & str_starts(name, regex("Yamato", TRUE)) ~ -71.50000,
    ...
    reclong = case_when(
      ...
      reclat_original == 0 & reclong_original == 0 & str_starts(name, regex("Yamato",TRUE)) ~ 35.66667,
